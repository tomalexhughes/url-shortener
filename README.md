...
To prevent implementing full OAuth authentication API request are verified with a 'Generic Access Token' that can be generated within by logging in to [Bitly](https://bitly.com).
